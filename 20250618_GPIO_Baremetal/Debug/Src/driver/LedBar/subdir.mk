...
Src/driver/LedBar/%.o Src/driver/LedBar/%.su Src/driver/LedBar/%.cyclo: ../Src/driver/LedBar/%.c Src/driver/LedBar/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m4 -std=gnu11 -g3 -DDEBUG -DSTM32 -DSTM32F4 -DSTM32F411RETx -c -I../Inc -I"C:/stm32_Harman/20250618_GPIO_Baremetal/Src/driver/GPIO" -I"C:/stm32_Harman/20250618_GPIO_Baremetal/Src/driver/LedBar" -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -fcyclomatic-complexity -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@"
