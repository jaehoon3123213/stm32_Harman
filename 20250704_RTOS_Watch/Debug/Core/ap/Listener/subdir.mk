...
clean-Core-2f-ap-2f-Listener:
	-$(RM) ./Core/ap/Listener/Listener.cyclo ./Core/ap/Listener/Listener.d ./Core/ap/Listener/Listener.o ./Core/ap/Listener/Listener.su ./Core/ap/Listener/Listener_StopWatch.cyclo ./Core/ap/Listener/Listener_StopWatch.d ./Core/ap/Listener/Listener_StopWatch.o ./Core/ap/Listener/Listener_StopWatch.su ./Core/ap/Listener/Listener_TempHumid.cyclo ./Core/ap/Listener/Listener_TempHumid.d ./Core/ap/Listener/Listener_TempHumid.o ./Core/ap/Listener/Listener_TempHumid.su ./Core/ap/Listener/Listener_TimeWatch.cyclo ./Core/ap/Listener/Listener_TimeWatch.d ./Core/ap/Listener/Listener_TimeWatch.o ./Core/ap/Listener/Listener_TimeWatch.su ./Core/ap/Listener/Listener_distance.cyclo ./Core/ap/Listener/Listener_distance.d ./Core/ap/Listener/Listener_distance.o ./Core/ap/Listener/Listener_distance.su
